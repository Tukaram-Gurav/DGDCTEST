...
@Entity
@Table(name = "forward_out")
@IdClass(ForwardId.class)
public class Forward_out {
	@Id
	...
	@Column(name="Forward_out_date")
	private Date forwardoutDate;
	public Forward_out() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Forward_out(String companyId, String branchId, String erp_doc_ref_no, String doc_ref_no, String packageNo,
		...
		this.party = party;
		this.nop = nop;
		this.forwardoutDate = forwardoutDate;
	}
	...
	public Date getForwardoutDate() {
		return forwardoutDate;
	}
	public void setForwardoutDate(Date forwardoutDate) {
		this.forwardoutDate = forwardoutDate;
	}
