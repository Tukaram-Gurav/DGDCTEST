...
@Entity
@Table(name = "Percfinvsrvdtl")
@IdClass(ProformaDetailId.class)
public class ProformaDetail {
	...
	public ProformaDetail( String companyId, String branchId, String proformaNo, String partyId,
			String serviceId, Date proformaNoDate, String executionUnit, String serviceUnit1, String executionUnit1,
			double rate, String currencyId, double taxPercentage, double taxAmount, double billAmount,
			double totalInvoiceAmount, String status, String createdBy, Date createdDate, String editedBy,
